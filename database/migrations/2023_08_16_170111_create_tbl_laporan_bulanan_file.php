...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('tbl_laporan_bulanan_file', function (Blueprint $table) {
            ...
            $table->integer('status_laporan_bulanan_file')->length(1)->nullable();
            $table->integer('statusactive_laporan_bulanan_file')->length(1)->nullable();
    ...
    {
        Schema::dropIfExists('tbl_laporan_bulanan_file');
    }
};
