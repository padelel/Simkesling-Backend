...
// Grup utama dengan prefix /v1
Route::prefix('v1')->group(function () {

    // Tangani semua preflight (OPTIONS) di bawah /api/v1/*
    ...
    // == RUTE TERPROTEKSI (WAJIB MENGGUNAKAN TOKEN) ==
    Route::middleware('ceklogin.webnext')->group(function () {
        // Letakkan semua rute yang memerlukan otentikasi di dalam grup ini
        Route::post('/', [LandingController::class, 'testApi'])->name('api.v1.protected.testapi');

        // auth endpoints (cookie/Bearer)
